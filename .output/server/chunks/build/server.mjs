...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-CvtdHqQ8.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-C9TnZkQ0.mjs')
  },
  {
    name: "register",
    path: "/register",
    component: () => import('./register-JSf7DPy_.mjs')
  },
  {
    name: "services",
    path: "/services",
    component: () => import('./services-XjuxelBp.mjs')
  }
];
...
const layouts = {
  default: () => import('./default-P25eH3Au.mjs')
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DeYAkHfi.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CLv06YN1.mjs'));
...
export { _export_sfc as _, __nuxt_component_1 as a, useRouter as b, resolveRouteObject as c, navigateTo as d, entry$1 as default, useRuntimeConfig as e, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useNuxtApp as u };
